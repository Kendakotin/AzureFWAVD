        ...
        ${p.steps.map((s, idx) => `
          <div class="step">
            ...
            <div class="shot-wrap">
              ...
              <div class="shot-note">If this shows the placeholder, add your real portal screenshot at <code>assets/screens/${p.id}/step-${String(idx+1).padStart(2,'0')}.png</code>.</div>
            </div>
          </div>
        `).join("")}
      </div>
